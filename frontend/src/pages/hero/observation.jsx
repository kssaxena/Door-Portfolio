...
const Observation = () => {
    ...
    return (
      <div className="flex justify-center items-center gap-5 h-full">
        {mappingData3.map((data, index) => (
          <div
            key={index}
            className={`flex flex-col justify-start items-start border-[0.2px] border-neutral-800 gap-5 w-fit h-[70vh]`}
          >
  ...
  return (
    <div className="px-40 py-20 relative">
      <p className="absolute top-20 left-20 text-xs uppercase">studio notes</p>
